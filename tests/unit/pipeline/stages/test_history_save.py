...
class TestHistorySaveStage:
    ...
    def test_stage_initialization(self, mock_chat_llm, mock_session_manager, mock_bridge):
    ...
    async def test_process_saves_to_session_manager(self, mock_session_manager, mock_processed):
        ...
        from core.pipeline.stages.history_save import HistorySaveStage
        stage = HistorySaveStage(None, mock_session_manager, None, chat_agent=MagicMock())

        # Setup chat_snapshots with user+assistant pair
        snapshots = {
            "qq:dm:user123": [
        ...
        stage._chat_snapshots = snapshots
        ...
        mock_session_manager.append_memory.assert_called_once_with(
            "qq:dm:user123",
            {"role": "user", "content": "User message"},
            {"role": "assistant", "content": "AI reply"}
        )
    ...
    async def test_process_handles_chat_agent_mode(self, mock_chat_agent, mock_session_manager, mock_processed):
        ...
        mock_session_manager.append_memory.assert_called()
